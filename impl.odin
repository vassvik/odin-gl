...
impl_TexImage1D:             proc "c" (target: u32, level: i32, internalformat: i32, width: i32, border: i32, format: u32, type_: u32, pixels: rawptr);
impl_TexImage2D:             proc "c" (target: u32, level: i32, internalformat: i32, width: i32, height: i32, border: i32, format: u32, type_: u32, pixels: rawptr);
...
impl_ReadPixels:             proc "c" (x: i32, y: i32, width: i32, height: i32, format: u32, type_: u32, pixels: rawptr);
impl_GetBooleanv:            proc "c" (pname: u32, data: ^u8);
...
impl_GetTexImage:            proc "c" (target: u32,  level: i32, format: u32, type_: u32, pixels: rawptr);
...
impl_IsEnabled:              proc "c" (cap: u32) -> u8;
...
impl_BindAttribLocation:       proc "c" (program: u32, index: u32, name: ^u8);
impl_CompileShader:            proc "c" (shader: u32);
impl_CreateProgram:            proc "c" () -> u32;
impl_CreateShader:             proc "c" (type_: u32) -> u32;
...
impl_GetActiveAttrib:          proc "c" (program: u32, index: u32, bufSize: i32, length: ^i32, size: ^i32, type_: ^u32, name: ^u8);
impl_GetActiveUniform:         proc "c" (program: u32, index: u32, bufSize: i32, length: ^i32, size: ^i32, type_: ^u32, name: ^u8);
...
impl_IsProgram:                proc "c" (program: u32) -> u8;
impl_IsShader:                 proc "c" (shader: u32) -> u8;
impl_LinkProgram:              proc "c" (program: u32);
impl_ShaderSource:             proc "c" (shader: u32, count: i32, string: ^^u8, length: ^i32);
...
impl_UniformMatrix2fv:         proc "c" (location: i32, count: i32, transpose: u8, value: ^f32);
impl_UniformMatrix3fv:         proc "c" (location: i32, count: i32, transpose: u8, value: ^f32);
impl_UniformMatrix4fv:         proc "c" (location: i32, count: i32, transpose: u8, value: ^f32);
...
impl_VertexAttribPointer:      proc "c" (index: u32, size: i32, type_: u32, normalized: u8, stride: i32, pointer: rawptr);
...
// VERSION_3_0
 ...
 impl_GetBooleani_v:                       proc "c" (target: u32, index: u32, data: ^u8);
 ...
 impl_IsEnabledi:                          proc "c" (target: u32, index: u32) -> u8;
 ...
 impl_TransformFeedbackVaryings:           proc "c" (program: u32, count: i32, varyings: ^u8, bufferMode: u32);
 impl_GetTransformFeedbackVarying:         proc "c" (program: u32, index: u32, bufSize: i32, length: ^i32, size: ^i32, type_: ^u32, name: ^u8);
 ...
 impl_VertexAttribIPointer:                proc "c" (index: u32, size: i32, type_: u32, stride: i32, pointer: rawptr);
 ...
 impl_BindFragDataLocation:                proc "c" (program: u32, color: u32, name: ^u8);
 impl_GetFragDataLocation:                 proc "c" (program: u32, name: ^u8) -> i32;
 ...
 impl_IsFramebuffer:                       proc "c" (framebuffer: u32) -> u8;
 ...
 impl_IsVertexArray:                       proc "c" (array: u32) -> u8;
...
// VERSION_3_3
impl_BindFragDataLocationIndexed: proc "c" (program: u32, colorNumber: u32, index: u32, name: ^u8);
impl_GetFragDataIndex:            proc "c" (program: u32, name: ^u8) -> i32;
impl_GenSamplers:                 proc "c" (count: i32, samplers: ^u32);
impl_DeleteSamplers:              proc "c" (count: i32, samplers: ^u32);
impl_IsSampler:                   proc "c" (sampler: u32) -> u8;
...
impl_VertexAttribP1ui:            proc "c" (index: u32, type_: u32, normalized: u8, value: u32);
impl_VertexAttribP1uiv:           proc "c" (index: u32, type_: u32, normalized: u8, value: ^u32);
impl_VertexAttribP2ui:            proc "c" (index: u32, type_: u32, normalized: u8, value: u32);
impl_VertexAttribP2uiv:           proc "c" (index: u32, type_: u32, normalized: u8, value: ^u32);
impl_VertexAttribP3ui:            proc "c" (index: u32, type_: u32, normalized: u8, value: u32);
impl_VertexAttribP3uiv:           proc "c" (index: u32, type_: u32, normalized: u8, value: ^u32);
impl_VertexAttribP4ui:            proc "c" (index: u32, type_: u32, normalized: u8, value: u32);
impl_VertexAttribP4uiv:           proc "c" (index: u32, type_: u32, normalized: u8, value: ^u32);
impl_VertexP2ui:                  proc "c" (type_: u32, value: u32);
impl_VertexP2uiv:                 proc "c" (type_: u32, value: ^u32);
impl_VertexP3ui:                  proc "c" (type_: u32, value: u32);
impl_VertexP3uiv:                 proc "c" (type_: u32, value: ^u32);
impl_VertexP4ui:                  proc "c" (type_: u32, value: u32);
impl_VertexP4uiv:                 proc "c" (type_: u32, value: ^u32);
impl_TexCoordP1ui:                proc "c" (type_: u32, coords: u32);
impl_TexCoordP1uiv:               proc "c" (type_: u32, coords: ^u32);
impl_TexCoordP2ui:                proc "c" (type_: u32, coords: u32);
impl_TexCoordP2uiv:               proc "c" (type_: u32, coords: ^u32);
impl_TexCoordP3ui:                proc "c" (type_: u32, coords: u32);
impl_TexCoordP3uiv:               proc "c" (type_: u32, coords: ^u32);
impl_TexCoordP4ui:                proc "c" (type_: u32, coords: u32);
impl_TexCoordP4uiv:               proc "c" (type_: u32, coords: ^u32);
impl_MultiTexCoordP1ui:           proc "c" (texture: u32, type_: u32, coords: u32);
impl_MultiTexCoordP1uiv:          proc "c" (texture: u32, type_: u32, coords: ^u32);
impl_MultiTexCoordP2ui:           proc "c" (texture: u32, type_: u32, coords: u32);
impl_MultiTexCoordP2uiv:          proc "c" (texture: u32, type_: u32, coords: ^u32);
impl_MultiTexCoordP3ui:           proc "c" (texture: u32, type_: u32, coords: u32);
impl_MultiTexCoordP3uiv:          proc "c" (texture: u32, type_: u32, coords: ^u32);
impl_MultiTexCoordP4ui:           proc "c" (texture: u32, type_: u32, coords: u32);
impl_MultiTexCoordP4uiv:          proc "c" (texture: u32, type_: u32, coords: ^u32);
impl_NormalP3ui:                  proc "c" (type_: u32, coords: u32);
impl_NormalP3uiv:                 proc "c" (type_: u32, coords: ^u32);
impl_ColorP3ui:                   proc "c" (type_: u32, color: u32);
impl_ColorP3uiv:                  proc "c" (type_: u32, color: ^u32);
impl_ColorP4ui:                   proc "c" (type_: u32, color: u32);
impl_ColorP4uiv:                  proc "c" (type_: u32, color: ^u32);
impl_SecondaryColorP3ui:          proc "c" (type_: u32, color: u32);
impl_SecondaryColorP3uiv:         proc "c" (type_: u32, color: ^u32);
...
impl_DrawElementsIndirect:           proc "c" (mode: u32, type_: u32, indirect: rawptr);
...
impl_UniformMatrix2dv:               proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix3dv:               proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix4dv:               proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix2x3dv:             proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix2x4dv:             proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix3x2dv:             proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix3x4dv:             proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix4x2dv:             proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_UniformMatrix4x3dv:             proc "c" (location: i32, count: i32, transpose: u8, value: ^f64);
impl_GetUniformdv:                   proc "c" (program: u32, location: i32, params: ^f64);
impl_GetSubroutineUniformLocation:   proc "c" (program: u32, shadertype_: u32, name: ^u8) -> i32;
impl_GetSubroutineIndex:             proc "c" (program: u32, shadertype_: u32, name: ^u8) -> u32;
impl_GetActiveSubroutineUniformiv:   proc "c" (program: u32, shadertype_: u32, index: u32, pname: u32, values: ^i32);
impl_GetActiveSubroutineUniformName: proc "c" (program: u32, shadertype_: u32, index: u32, bufsize: i32, length: ^i32, name: ^u8);
impl_GetActiveSubroutineName:        proc "c" (program: u32, shadertype_: u32, index: u32, bufsize: i32, length: ^i32, name: ^u8);
impl_UniformSubroutinesuiv:          proc "c" (shadertype_: u32, count: i32, indices: ^u32);
impl_GetUniformSubroutineuiv:        proc "c" (shadertype_: u32, location: i32, params: ^u32);
impl_GetProgramStageiv:              proc "c" (program: u32, shadertype_: u32, pname: u32, values: ^i32);
...
impl_IsTransformFeedback:            proc "c" (id: u32) -> u8;
...
impl_GetShaderPrecisionFormat:  proc "c" (shadertype_: u32, precisiontype_: u32, range: ^i32, precision: ^i32);
...
impl_CreateShaderProgramv:      proc "c" (type_: u32, count: i32, strings: ^u8) -> u32;
...
impl_IsProgramPipeline:         proc "c" (pipeline: u32) -> u8;
...
impl_ProgramUniformMatrix2fv:   proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix3fv:   proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix4fv:   proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix2dv:   proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix3dv:   proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix4dv:   proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix2x3fv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix3x2fv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix2x4fv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix4x2fv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix3x4fv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix4x3fv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f32);
impl_ProgramUniformMatrix2x3dv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix3x2dv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix2x4dv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix4x2dv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix3x4dv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
impl_ProgramUniformMatrix4x3dv: proc "c" (program: u32, location: i32, count: i32, transpose: u8, value: ^f64);
...
impl_VertexAttribLPointer:      proc "c" (index: u32, size: i32, type_: u32, stride: i32, pointer: rawptr);
...
// VERSION_4_3
impl_ClearBufferData:                 proc "c" (target: u32, internalformat: u32, format: u32, type_: u32, data: rawptr);
impl_ClearBufferSubData:              proc "c" (target: u32, internalformat: u32, offset: int, size: int, format: u32, type_: u32, data: rawptr);
...
impl_MultiDrawElementsIndirect:       proc "c" (mode: u32, type_: u32, indirect: rawptr, drawcount: i32, stride: i32);
impl_GetProgramInterfaceiv:           proc "c" (program: u32, programInterface: u32, pname: u32, params: ^i32);
impl_GetProgramResourceIndex:         proc "c" (program: u32, programInterface: u32, name: ^u8) -> u32;
...
impl_GetProgramResourceLocation:      proc "c" (program: u32, programInterface: u32, name: ^u8) -> i32;
impl_GetProgramResourceLocationIndex: proc "c" (program: u32, programInterface: u32, name: ^u8) -> i32;
...
impl_VertexAttribFormat:              proc "c" (attribindex: u32, size: i32, type_: u32, normalized: u8, relativeoffset: u32);
impl_VertexAttribIFormat:             proc "c" (attribindex: u32, size: i32, type_: u32, relativeoffset: u32);
impl_VertexAttribLFormat:             proc "c" (attribindex: u32, size: i32, type_: u32, relativeoffset: u32);
...
impl_DebugMessageControl:             proc "c" (source: u32, type_: u32, severity: u32, count: i32, ids: ^u32, enabled: u8);
impl_DebugMessageInsert:              proc "c" (source: u32, type_: u32, id: u32, severity: u32, length: i32, buf: ^u8);
...
impl_ClearNamedBufferData:                     proc "c" (buffer: u32, internalformat: u32, format: u32, type_: u32, data: rawptr);
impl_ClearNamedBufferSubData:                  proc "c" (buffer: u32, internalformat: u32, offset: int, size: int, format: u32, type_: u32, data: rawptr);
...
impl_UnmapNamedBuffer:                         proc "c" (buffer: u32) -> u8;
...
impl_TextureSubImage1D:                        proc "c" (texture: u32, level: i32, xoffset: i32, width: i32, format: u32, type_: u32, pixels: rawptr);
impl_TextureSubImage2D:                        proc "c" (texture: u32, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: u32, type_: u32, pixels: rawptr);
impl_TextureSubImage3D:                        proc "c" (texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, type_: u32, pixels: rawptr);
...
impl_GetTextureImage:                          proc "c" (texture: u32, level: i32, format: u32, type_: u32, bufSize: i32, pixels: rawptr);
...
impl_VertexArrayVertexBuffers:                 proc "c" (vaobj: u32, first: u32, count: i32, buffers: ^u32, offsets: ^int, strides: ^i32);
impl_VertexArrayAttribBinding:                 proc "c" (vaobj: u32, attribindex: u32, bindingindex: u32);
impl_VertexArrayAttribFormat:                  proc "c" (vaobj: u32, attribindex: u32, size: i32, type_: u32, normalized: u8, relativeoffset: u32);
impl_VertexArrayAttribIFormat:                 proc "c" (vaobj: u32, attribindex: u32, size: i32, type_: u32, relativeoffset: u32);
impl_VertexArrayAttribLFormat:                 proc "c" (vaobj: u32, attribindex: u32, size: i32, type_: u32, relativeoffset: u32);
...
impl_GetTextureSubImage:                       proc "c" (texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, type_: u32, bufSize: i32, pixels: rawptr);
...
impl_GetnTexImage:                             proc "c" (target: u32, level: i32, format: u32, type_: u32, bufSize: i32, pixels: rawptr);
...
impl_ReadnPixels:                              proc "c" (x: i32, y: i32, width: i32, height: i32, format: u32, type_: u32, bufSize: i32, data: rawptr);
...
impl_GetnColorTable:                           proc "c" (target: u32, format: u32, type_: u32, bufSize: i32, table: rawptr);
impl_GetnConvolutionFilter:                    proc "c" (target: u32, format: u32, type_: u32, bufSize: i32, image: rawptr);
impl_GetnSeparableFilter:                      proc "c" (target: u32, format: u32, type_: u32, rowBufSize: i32, row: rawptr, columnBufSize: i32, column: rawptr, span: rawptr);
...
impl_MultiDrawElementsIndirectCount: proc "c" (mode: i32, type_: i32, indirect: rawptr, drawcount: int, maxdrawcount, stride: i32);
